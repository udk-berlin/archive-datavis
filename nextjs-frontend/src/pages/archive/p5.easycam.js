...
var Dw = (function (ext) {
  ...
  class EasyCam {
    ...
    beginHUD(renderer, w, h) {
      ...
      const VERSION = window.VERSION !== undefined ? window.VERSION : "1.9.4";
...
function easyCam_ini(p5) {
  if (p5) {
     ...
     */
    p5.constructor.prototype.createEasyCam = function (/* p5.RendererGL, {state} */) {
      var renderer = this._renderer;
      var args = arguments[0];

      if (arguments[0] instanceof p5.constructor.RendererGL) {
